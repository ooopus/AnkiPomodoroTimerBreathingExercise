...
from PyQt6.QtGui import QPainter, QColor, QPen, QGradient, QLinearGradient, QConicalGradient, QBrush
from aqt import mw
...
class CircularTimer(QWidget):
    ...
    def paintEvent(self, event):
        ...
        rainbow_gradient.setSpread(QGradient.Spread.ReflectSpread)  # 反射模式使颜色过渡更平滑
        ...
        for i in range(3, 0, -1):
            ...
            painter.setPen(shadow_color)
            painter.drawText(
                rect.adjusted(shadow_offset*i, shadow_offset*i, shadow_offset*i, shadow_offset*i),
                Qt.AlignmentFlag.AlignCenter,
                self.remaining_time
            )
